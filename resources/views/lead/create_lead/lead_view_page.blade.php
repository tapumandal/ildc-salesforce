			...
			<div class="row">
				...
				<div class="col-sm-6">
					<div class="form-group add_input">
						...
						<div class="col-sm-12">
							<select class="form-control" name="lead_type" readonly>
				...
				<div class="col-sm-6">
					...
					<div class="form-group add_input">
						...
						<div class="col-sm-12">
							<input type="text" class="form-control" name="personal_name" value="{{$valueslead->personal_name}}" placeholder="Name" readonly>
						</div>
					</div>
				</div>
				...
				<div class="col-sm-6">
					<div class="form-group add_input">
						...
						<div class="col-sm-12">
							<input type="email" class="form-control"  name="email" value="{{$valueslead->email}}" placeholder="Email" readonly>
						</div>
					</div>
					...
					<div class="form-group add_input">
						...
						<div class="col-sm-12">
							<input type="text" class="form-control" name="contact_no" value="{{ $object->emptys($valueslead->contact_no)}}" placeholder="01*00" readonly>
						</div>
					</div>
				</div>
				...
				<div class="col-sm-6">
					<div class="form-group add_input">
						...
						<div class="col-sm-12">
							<input type="text" class="form-control" name="area" value="{{ $object->emptys($valueslead->area) }}" placeholder="Area" readonly>
						</div>
					</div>
					<div class="form-group add_input">
						<label class="col-sm-4 control-label">
						...
						<div class="col-sm-12">
							<select class="form-control" name="occupation" readonly>
			...
			<div class="row">
				...
				<div class="col-sm-4">
					<div class="form-group add_input">
						...
						<div class="col-sm-12">
							<select class="form-control" name="investment_name" readonly>
								<option value=""> Choose a option</option>
				...
				<div class="col-sm-4">
					<div class="form-group add_input">
						...
						<div class="col-sm-12">
							<select class="form-control" name="investment_type" readonly>
				...
				<div class="col-sm-4">
					<div class="form-group add_input">
						...
						<div class="col-sm-12">
							<input type="text" class="form-control"  name="investment_date" value="{{$object->emptys($valueslead->follow_up_date)}}" placeholder="Follow-up Name" readonly>
						</div>
					</div>
				</div>
				...
				<div class="col-sm-4">
					<div class="form-group add_input">
						...
						<div class="col-sm-12">
							<select class="form-control" name="contact_status" readonly>
								<option value="">Choose a option</option>
				...
				<div class="col-sm-4">
					<div class="form-group add_input">
						...
						<div class="col-sm-12">
							<select class="form-control" name="interest_label" readonly>
								<option value="">Choose a option</option>
				...
				<div class="col-sm-4">
					<div class="form-group add_input">
						...
						<div class="col-sm-12">
							<select class="form-control" name="investment_action" readonly>
								<option value="">Choose a option</option>
				...
				<div class="col-sm-12">
					<div class="form-group">
						...
						<div class="col-sm-12">
							<div class="col-sm-8">
								<textarea class="form-control" name="remark_or_comment" readonly>
