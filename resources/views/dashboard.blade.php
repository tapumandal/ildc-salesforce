...
@section('section')
            ...
            <div class="row">
                ...
                @section ('pane2_panel_title', 'Application in progress')
                        ...
                        <li>
                            ...
                            <div class="timeline-panel">
                                <div class="timeline-heading">
                                    <h4 class="timeline-title">Incomplete</h4>
                ...
                <!-- /.col-lg-8 -->
                <div class="col-lg-4">
                    @section ('cchart11_panel_title','Conversion ratio')
