...
@section('page_heading','Update New Organization')
@section('section')
		...
		<div class="col-sm-10 col-sm-offset-1">
			<div class="panel panel-default add_body">
				<div class="panel-body">
					...
					<form action="{{route('update_organization')}}/{{$value->id_organization}}" method="POST">
						<input type="hidden" name="_token" value="{{ csrf_token() }}">
							...
							<div class="form-group add_input{{ $errors->has('organization_name') ? ' has-error' : ''}}">
								...
								<div class="col-md-6">
									<input type="text" class="form-control" name="organization_name" value="{{$value->organization_name}}" placeholder="Organization Name">
							...
							<div class="form-group add_input{{ $errors->has('contact_person_name') ? ' has-error' : ''}}">
								...
								<div class="col-md-6">
									<input type="text" class="form-control" name="contact_person_name" value="{{$value->contact_person_name}}" placeholder="Contact Person Name">
							...
							<div class="form-group add_input{{ $errors->has('contact_person_no') ? ' has-error' : ''}}">
								...
								<div class="col-md-6">
									<input type="text" class="form-control" name="contact_person_no" value="{{ $value->contact_person_no }}" placeholder="Contact Person No">
